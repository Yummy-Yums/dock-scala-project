...
final case class GenericServerError(message: String) extends Exception derives Codec.AsObject, Schema

object GenericServerError {
  given Eq[GenericServerError]
}